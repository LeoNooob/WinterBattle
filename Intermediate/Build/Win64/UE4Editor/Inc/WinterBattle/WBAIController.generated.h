...
#ifdef WINTERBATTLE_WBAIController_generated_h
#error "WBAIController.generated.h already included, missing '#pragma once' in WBAIController.h"
#endif
...
public: \
	DECLARE_CLASS(AWBAIController, AAIController, COMPILED_IN_FLAGS(0), 0, TEXT("/Script/WinterBattle"), NO_API) \
	DECLARE_SERIALIZER(AWBAIController) \
...
#define WinterBattle_Source_WinterBattle_WBAIController_h_15_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, AWBAIController); \
DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(AWBAIController); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API AWBAIController(AWBAIController&&); \
	NO_API AWBAIController(const AWBAIController&); \
public:
